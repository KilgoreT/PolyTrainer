...
>
> 📎 guide: docs/guides/ui-patterns.md — раздел "Виджеты получают callbacks, не `sendMessage`"
...
> 📎 guide: docs/guides/ui-patterns.md — "AppBar никогда не пишется inline в Scaffold"
>
> 📎 guide: docs/guides/ui-patterns.md — "рендеринг списков через `key()` для стабильной рекомпозиции"
>
> 📎 guide: docs/guides/ui-patterns.md — "условные оверлеи (диалоги) рендерятся по флагам стейта"
...
> 📎 guide: docs/guides/ui-patterns.md — раздел "Виджеты получают callbacks, не `sendMessage`"
>
> 📎 guide: docs/guides/data-layer.md — раздел "Нормализация текстового ввода (trim)"
...
> 📎 guide: docs/guides/state-and-extensions.md — "`NOT_IN_DB = -1L`; локальная LexemeState до INSERT в БД"
>
...
> 📎 guide: docs/guides/theme-and-resources.md — "Material3 цвет → LexemeColor + darkColorScheme()"
