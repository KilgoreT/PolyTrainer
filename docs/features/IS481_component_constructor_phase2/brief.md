...
**Полный список расхождений** — см. `docs/features/IS481_component_constructor/__plan_vs_reality.md`.
**Концептуальная база** (не меняется) — `docs/features/IS481_component_constructor/concept/`:
