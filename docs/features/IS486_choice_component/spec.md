...
- `setEnabled(typeId, enabled): EnableOutcome` — IS486 (фаза 2): рубильник с валидацией §7.8 (`LastEnabledCore`).
...
Ручной девайс-чек-лист (27 сценариев) — `manual_test_checklist.md`, пройден 2026-07-21.
