...
/**
 * Unit tests для [DatasourceEffectHandler] (PerDict Mate). Зеркально CM tests +
 * F125 (CancellationException re-throw) + epochId/typeId correlation propagation.
 */
